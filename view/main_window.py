...
class _NavItem(ctk.CTkFrame):
    ...
    def __init__(self, master, rotulo, command):
        ...
        self.lbl_texto = ctk.CTkLabel(self, text=rotulo, anchor="w", font=theme.fonte_padrao())
...
class MainWindow(ctk.CTkFrame):
    ...
    def _chaves_permitidas(self):
        ...
        return [k for k, _rotulo in MENU if permitido is None or k in permitido]
    ...
    def _montar_sidebar(self):
        ...
        ctk.CTkLabel(
            topo,
            text=self.sessao.get("username", ""),
            text_color=theme.COR_TEXTO_FRACO,
            font=ctk.CTkFont(size=12),
        ).pack(anchor="w")
        ctk.CTkLabel(
            topo,
            text=f"Perfil: {role or '—'}",
            text_color=cor,
        ...
        ctk.CTkButton(
            ...
            text="Sair",
            height=40,
            fg_color=theme.COR_PERIGO,
            hover_color=theme.COR_PERIGO_HOVER,
